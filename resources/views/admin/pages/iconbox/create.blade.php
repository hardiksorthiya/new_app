    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="heading-with-btn">
                <h3 class="content-title">Add Icon Box</h3>
            </div>
        </div>
        @if ($errors->any())
        ...
        <div class="col-lg-12">
            <div class="section-ineer-main page-design">
                <form action="/admin/iconbox" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="row">
                                <div class="right-side-create-page">
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="box_text" class="input-field-hp edit-field-hp">
                                            @error('name')
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <textarea name="box_description" class="input-field-hp edit-field-hp" rows="3"></textarea>
